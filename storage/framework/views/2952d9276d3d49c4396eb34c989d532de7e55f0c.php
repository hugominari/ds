<?php $__env->startSection('content'); ?>
	...
	<?php echo Form::open(['route' => ['members.update', $member->id], 'method' => 'PUT', 'class' => 'ajax-form']); ?>
		...
		<div class="row">
		    <div class="col-md-4">
				<div class="card">
					...
					<div class="card-body">
						<?php echo e(Form::cDropzone('image', $member->image, '', '1', 'Selecione uma imagem.', 'drop-square w-r-100')); ?>
