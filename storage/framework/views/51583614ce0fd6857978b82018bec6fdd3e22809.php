...
<?php $__env->startSection('content'); ?>
    <section class="content-header">
        <div class="row m-b-10">
            <div class="col-md-8">
                <h1><i class="fas fa-mouse-pointer"></i> Sites Úteis</h1>
            </div>
            <div class="col-md-4">
        ...
        <div class="row">
                    ...
                    <div class="col-md-12">
                        <div class="card">
                            ...
                            <div class="card-body">
                                ...
                                <?php echo e(Form::cText('url', '', 'Site')); ?>
                            ...
                            <div class="card-footer d-none">
                                ...
                                <?php echo e(Form::cText('model', 'websites', '', ['class' => 'hide'])); ?>
            ...
            <div class="col-lg-7 col-md-7 col-sm-12">
                <div class="card">
                    ...
                    <div class="card-body">
                        <table class="dataTable w-r-100" data-source="<?php echo route('basic.list', 'websites'); ?>" data-type="datatables">
                            <thead>
                                <tr>
                                    <th data-slug="name" class="sort default-sort">Nome</th>
                                    <th data-slug="url" class="no-sort">Site</th>
                                    <th data-slug="type" class="no-sort">Tipo</th>
