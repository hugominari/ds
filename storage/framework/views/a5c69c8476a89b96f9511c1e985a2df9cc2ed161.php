<?php $__env->startSection('content'); ?>
	<section class="content-header">
		<div class="row m-b-10">
			<div class="col-md-8">
				<h1><i class="fas fa-hands-helping"></i> Cadastro de Convênio</h1>
			</div>
			<div class="col-md-4">
	...
	<?php echo Form::open(['route' => 'covenants.store', 'method' => 'POST', 'class' => 'ajax-form']); ?>
				...
				<div class="card">
					...
					<div class="card-body">
						<div class="form-row">
							...
							<div class="col-md-6">
								<?php echo e(Form::cText('url', '', 'Url (Site)')); ?>
