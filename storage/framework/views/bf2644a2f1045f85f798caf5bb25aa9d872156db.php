<div class="modal fade" id="makeAttendance" tabindex="-1" role="dialog">
	<div class="modal-dialog modal-full-height modal-right modal-notify modal-info hidden" role="document">
		<div class="modal-content">
			<?php echo Form::open(['route' => 'attendance.store', 'method' => 'POST', 'class' => 'ajax-form']); ?>
				...
				<div class="modal-body">
					...
					<hr>
					<?php echo e(Form::cText('name', '', 'Nome do cliente')); ?>

					<?php echo e(Form::cText('cpf', '', 'CPF', ['class' => 'form-control cpf'])); ?>

					<div class="row">
						<div class="col-md-12">
							<?php echo e(Form::cSelect('type_call_id', '', 'Tipo de Atendimento', $typeAttendances)); ?>

						</div>
					</div>
					<?php echo e(Form::cDateInline('date', '', 'Data do atendimento')); ?>

					<?php echo e(Form::cTextarea('description', '', 'Descrição', ['rows' => 2])); ?>
