<?php $__env->startSection('content'); ?>
	<section class="content-header">
		<div class="row m-b-10">
			<div class="col-md-8">
				<h1><i class="fa fa-newspaper"></i> Edição de Notícia</h1>
			</div>
			<div class="col-md-4">
	...
	<?php echo Form::open(['route' => ['news.update', $news->id], 'method' => 'PUT', 'class' => 'ajax-form']); ?>
		...
		<div class="row">
		    <div class="col-md-4">
				<div class="card">
					...
					<div class="card-body">
						<?php echo e(Form::cDropzone('image', $news->image, '', '1', 'Clique ou arraste uma imagem aqui', 'drop-rounded')); ?>
		    ...
		    <div class="col-md-8">
				<div class="card">
					...
					<div class="card-body">
						<div class="form-row">
							<div class="col-md-12">
								<?php echo e(Form::cText('title', $news->title, 'Titulo')); ?>

							</div>
						</div>
						<div class="form-row">
							<div class="col-md-12">
								<?php echo e(Form::cTextarea('description', $news->description, 'Descrição', ['class' => 'ckeditor'])); ?>

							</div>
						</div>
						<div class="form-row">
							<div class="col-md-5">
								<?php echo e(Form::cSelect('type', $news->type, 'Tipo', $types)); ?>

							</div>
							<div class="col-md-7">
								<?php echo e(Form::cText('source', $news->source, 'Fonte')); ?>
