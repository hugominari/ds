...
<?php $__env->startSection('content'); ?>
	<section class="content-header">
		<div class="row m-b-10">
			...
			<div class="col-md-4">
				<a href="<?php echo e(route('news.create')); ?>" class="display-inline-block pull-right m-t-11">
	...
	<section class="content">
		<div class="row">
			<div class="col-md-12">
				<div class="card">
					<div class="card-body">
						<table class="table table-striped" cellspacing="0" width="100%" data-source="<?php echo e(route('news.list')); ?>" data-type="datatables">
							<thead>
								<tr>
