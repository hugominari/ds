<?php $__env->startSection('content'); ?>
	<section class="content-header">
		<div class="row m-b-10">
			<div class="col-md-8">
				<h1><i class="fa fa-newspaper"></i> Visualização de Publicação</h1>
			</div>
			<div class="col-md-4">
		...
		<div class="row">
		    <div class="col-md-4">
				<div class="card">
					...
					<div class="card-body">
						<?php echo e(Form::cDropzone('image', $post->image, '', '1', 'Clique ou arraste uma imagem aqui', 'drop-square w-r-100 disabled')); ?>
