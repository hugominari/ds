        ...
        <div class="row">
                ...
                <div class="row">
                    <div class="col-md-12">
                        <div class="card">
                            ...
                            <div class="card-body">
                                <?php echo e(Form::cText('name', '', 'Nome do atendimento')); ?>

                            </div>
                            <div class="card-footer d-none">
                                <?php echo e(Form::cText('id', '', '', ['class' => 'hide'])); ?>

                                <?php echo e(Form::cText('model', 'type_calls', '', ['class' => 'hide'])); ?>
            ...
            <div class="col-lg-7 col-md-7 col-sm-12">
                <div class="card">
                    ...
                    <div class="card-body">
                        <table class="display nowrap dataTable no-footer dtr-inline dt-responsive w-r-100" data-source="<?php echo route('basic.list', 'type_calls'); ?>" data-type="datatables">
                            <thead>
                                <tr>
