        ...
        <div class="row">
                ...
                <div class="row">
                    <div class="col-md-12">
                        <div class="card">
                            ...
                            <div class="card-body">
                                <?php echo e(Form::cText('name', '', 'Nome do Feed')); ?>
                            ...
                            <div class="card-footer d-none">
                                ...
                                <?php echo e(Form::cText('model', 'feeds', '', ['class' => 'hide'])); ?>
            ...
            <div class="col-lg-7 col-md-7 col-sm-12">
                <div class="card">
                    ...
                    <div class="card-body">
                        <table class="dataTable no-footer w-r-100" data-source="<?php echo route('basic.list', 'feeds'); ?>" data-type="datatables">
                            <thead>
                                <tr>
