<?php $__env->startSection('content'); ?>
	<section class="content-header">
		<div class="row m-b-10">
			<div class="col-md-8">
				<h1><i class="fas fa-theater-masks"></i> Cadastro de Cultura e Lazer</h1>
			</div>
			<div class="col-md-4">
	...
	<?php echo Form::open(['route' => 'cultures.store', 'method' => 'POST', 'class' => 'ajax-form']); ?>
		...
		<div class="row">
		    <div class="col-md-4">
				<div class="card">
					...
					<div class="card-body">
						<?php echo e(Form::cDropzone('image', '', '', '1', 'Clique ou arraste uma imagem aqui', 'drop-square w-r-100')); ?>
		    ...
		    <div class="col-md-8">
				<div class="card">
					...
					<div class="card-body">
						...
						<div class="form-row">
							<div class="col-md-12">
								<?php echo e(Form::cDate('date', '', 'Data')); ?>
