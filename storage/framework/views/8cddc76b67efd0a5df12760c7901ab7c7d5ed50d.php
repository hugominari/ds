<?php $__env->startSection('content'); ?>
	...
	<?php echo Form::open(['route' => 'members.store', 'method' => 'POST', 'class' => 'ajax-form']); ?>
		    ...
		    <div class="col-md-8">
				<div class="card">
					...
					<div class="card-body">
						...
						<div class="form-row">
							<div class="col-md-6">
								<?php echo e(Form::cCell('phone', '', 'Celular')); ?>
						...
						<div class="form-row">
							<div class="col-md-6">
								...
								<?php echo e(Form::cDate('birth_date', '', 'Data de Nascimento')); ?>
