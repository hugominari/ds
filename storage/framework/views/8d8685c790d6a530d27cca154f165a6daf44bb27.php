<?php $__env->startSection('content'); ?>
	...
	<?php echo Form::open(['route' => ['covenants.update', $covenant->id], 'method' => 'PUT', 'class' => 'ajax-form']); ?>
		    ...
		    <div class="col-md-4">
				<div class="card">
					...
					<div class="card-body box-icon text-center">
						<?php echo e(Form::cDropzone('image', $covenant->image, '', '1', 'Selecione uma imagem', 'drop-rounded')); ?>
