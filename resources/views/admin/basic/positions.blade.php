        ...
        <div class="row">
                    ...
                    <div class="col-md-12">
                        <div class="card">
                            ...
                            <div class="card-footer d-none">
                                ...
                                {{ Form::cText('model', 'positions', '', ['class' => 'hide']) }}
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <div class="col-lg-7 col-md-7 col-sm-12">
                <div class="card">
                    ...
                    <div class="card-body">
                        <table class="dataTable no-footer w-r-100" data-source="{!! route('basic.list', 'positions') !!}" data-type="datatables">
                            <thead>
                                <tr>
                                    <th data-slug="name" class="sort default-sort">Nome</th>
                                    {{--<th data-slug="members" class="sort">Membros</th>--}}
