        ...
        <div class="row">
                    ...
                    <div class="col-md-12">
                        <div class="card">
                            ...
                            <div class="card-body">
                                ...
                                <div class="row">
                                    <div class="col-md-12">
                                        {{ Form::cSelect('type', '', 'Tipo', $types) }}
                                    </div>
                                </div>
                            </div>
                            <div class="card-footer d-none">
                                {{ Form::cText('id', '', '', ['class' => 'hide']) }}
                                {{ Form::cText('model', 'websites', '', ['class' => 'hide']) }}
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <div class="col-lg-7 col-md-7 col-sm-12">
                <div class="card">
                    ...
                    <div class="card-body">
                        <table class="dataTable w-r-100" data-source="{!! route('basic.list', 'websites') !!}" data-type="datatables">
                            <thead>
                                <tr>
