...
@section('content')
	...
	{!! Form::open(['route' => ['attendance.update', $attendance->id], 'method' => 'PUT', 'class' => 'ajax-form']) !!}
		<div class="row">
		    <div class="col-md-4">
				<div class="card">
					...
					<div class="card-body">
						...
						<div class="row">
							<div class="col-md-12">
								{{ Form::cSelect('type_call_id', $attendance->type_call->id, 'Tipo de Atendimento', $typeAttendances) }}
							</div>
						</div>
 					</div>
				</div>
